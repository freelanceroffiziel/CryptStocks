    ...
    <main className="sideBar">
      <section className="sideBar">
        <section
          ...
          className="fixed lg:w-[20%] w-64 p-2 text-gray-100 bg-orange-800 hidden lg:block z-50 "
        >
          <div
            id="dashboardSideBarSohn"
            className="flex flex-col justify-between h-screen px-3 py-2 bg-orange-900 rounded shadow-lg "
          >
