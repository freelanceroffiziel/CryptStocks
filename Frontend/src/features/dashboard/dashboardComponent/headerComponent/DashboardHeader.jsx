  ...
  return (
    <main className="headerCon">
      <section className="headerConSon">
        ...
        >
          <div className=" desktop fixed z-50 top-0  bg-orange-800 p-2 w-full">
            <div
              id="contentHeroHeaderSon"
              className="bg-orange-900 rounded-md text-gray-50 flex flex-row items-center justify-between py-4 pl-4 pr-4  lg:w-[78vw] md:w-full w-full  top-0  "
            >
              <div
                id="menuIcon"
          ...
          >
            ...
            <li>
              <NavLink
                ...
                className="flex flex-row items-center gap-2 px-2 py-2  focus:text-white w-full  "
              >
