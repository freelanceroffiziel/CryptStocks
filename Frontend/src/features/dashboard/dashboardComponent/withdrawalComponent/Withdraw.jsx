  ...
  return (
    <main className="withdrawCon">
      <section className="withdrawCon">
        <div
          id="depositSonDiv"
          className="flex flex-col items-center justify-center gap-5 px-4 py-10 text-gray-100 bg-orange-900 rounded "
        >
          ...
          <form className="flex flex-col items-center justify-center w-full gap-10 ">
              ...
              <div className="flex flex-col gap-3 lg:w-[40%]   ">
                <span className="flex flex-col w-full gap-1 ">
                  ...
                  <select
                    id="amount"
                    name="fruit"
                    className="bg-orange-900 outline-none rounded-md bg-none border-[1px] border-gray-100 py-1.5 pl-1 "
                  >
            ...
            <span className="px-1 py-1 transition-all bg-green-900 rounded hover:bg-green-800 ">
              <button className="text-[28px] md:text-[22px] lg:text-[20px] bg-orange-950 px-4 py-1 rounded">
                Submit
              </button>
            </span>
          </form>
