...
const MyMeferralEarnings = () => {
  return (
    <>
      <main>
        <section className="px-6 py-6 text-gray-100 bg-orange-900 rounded ">
          <div
            id=""
                ...
                <span className="flex flex-row items-center gap-2">
                  <span className="flex flex-row items-center gap-2">
                    ...
                    <select
                      name="show"
                      id="show"
                      className="bg-orange-900 border-none rounded outline-none ring-1 ring-gray-400"
                    >
...
export default MyMeferralEarnings;
