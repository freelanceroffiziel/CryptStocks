...
const AccountInfoUpdate = () => {
  ...
  return (
    <main>
      <section>
        <div id="accountInfo" className="text-gray-100 bg-orange-900 rounded">
                  ...
                  <Form className="space-y-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <Field
                        ...
                        className="bg-orange-900 outline-none rounded-md border-[1px] border-gray-100 py-1.5 pl-1"
                      />
                      <ErrorMessage
                        name="phone"
                        component="div"
